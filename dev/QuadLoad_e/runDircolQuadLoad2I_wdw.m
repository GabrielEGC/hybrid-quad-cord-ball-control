...
% traj_opt=traj_opt.setSolverOptions('snopt','iterationslimit',20000);
% traj_opt=traj_opt.setSolverOptions('snopt','majoriterationslimit',2000);
% traj_opt=traj_opt.setSolverOptions('snopt','minoriterationslimit',1000);
